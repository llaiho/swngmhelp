...
import useSelectedStarSystem from "../hooks/useSelectedSystem";
...
const SystemView: FC = () => {
    // const system: StarSystem | undefined = useAtomValue<StarSystem | undefined>("SelectedSystem", undefined);
    
    const [system, change] = useSelectedStarSystem();
